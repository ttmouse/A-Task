...
> **你是这个分形系统的守护者。** 任何修改必须遵守以下强制协议。

### 1. 原子更新规则
任何功能、架构、写法更新，必须在代码修改完成后，**【立即同步更新对应目录的子文档】**。
...
```
文件变更 → 更新文件 Header → 更新所属文件夹 MD → （若影响全局）更新本文档
```
...
2. 更新成员清单
3. 检查是否影响本文档（OVERVIEW.md）

### 3. 分形自洽
确保系统在任何一个子目录下，Claude 都能通过该目录的 MD 理解当前世界观。

**自洽检验**：在任意文件夹下，AI 能否仅通过该目录的 README.md 理解当前子系统？

**触发条件**：核心架构/设计模式/技术栈变化时

**执行动作**：
1. 更新本文档的"核心架构设计"或"项目结构"
